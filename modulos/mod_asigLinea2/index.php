...
<input type="hidden" name="txtProcesoAsigLinea" id="txtProcesoAsigLinea" value="<?=$proceso;?>" />
<input type="hidden" name="txtIdUsuarioAsigLinea" id="txtIdUsuarioAsigLinea" value="<?=$_SESSION[$txtApp['session']['idUsuario']];?>" />
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			...
			<div style="float:right;width:200px;height:20px;padding:5px;background:#FFF;border:1px solid #CCC;font-size:16px;text-align:center;margin-right:217px;">Asignacion a Ingenier&iacute;a</div>
		</div>
		...
		<div id="infoEnsamble3"><br>
			...
			<div id="infoEquiposAsigLinea" style="border:1px solid #e1e1e1;background:#fff; height:90px;width:180px;font-size:20px;text-align:center;margin:0 auto 0 auto;"></div>
...
<div id="contenedorTest" style="height:100%; width:100%; overflow:hidden; background:#CCC;">	
    ...
    <table width="700" align="center" border="0" cellpadding="1" cellspacing="0" style="background:#999;">
        ...
        <tr>            
            <td colspan="2" align="left" style="background:#000; color:#FFF; height:25px;">Asignar Equipos a Producci&oacute;n</td>
        </tr>		
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
        <tr>            
            ...
            <td width="271"><input id="btnRegistrarImei" type="button" value="Registrar" onclick="registrarDatos()" style="width:200px; font-size:14px; height:45px;" /></td>
        </tr>
        <tr>
