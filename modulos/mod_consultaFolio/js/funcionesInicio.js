...
function mostrarResumenListadoReporte(div,status,folio){
	//alert(div+" "+status+" "+folio);
	parametros="action=mostrarInfoResumen&status="+status+"&folio="+folio+"&div="+div;
	ajaxApp(div,"controlador.php",parametros,"POST")
}
function cerrarDivReporteResumen(div){
	$("#"+div).hide();
}
