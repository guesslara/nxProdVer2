<?php
    ...
    $sqlTotalEquipos="SELECT count( DISTINCT detalle_ing.id_radio ) AS total,equipos.lineaEnsamble AS linea FROM detalle_ing INNER JOIN equipos ON detalle_ing.id_radio = equipos.id_radio WHERE (f_registro between '".$fechaIni."' AND '".$fechaFin."') AND(id_proc =4) AND equipos.status IN ('WIP','Validando','ENVIADO') GROUP BY equipos.lineaEnsamble";
    ...
    $myPicture->drawText(10,20,"Equipos Proc.",array("R"=>255,"G"=>255,"B"=>255));//10,13
