<?php
	...
	function exportarDatosCajaRecibo($cajaInterna){
		$nombreArchivo="equipos_SCRAP_2F".date("Y-m-d");
...
<?		
		...
		$sql="select id_radio,imei,serial,sim,modelo from equipos inner join cat_modradio on equipos.id_modelo=cat_modradio.id_modelo where status='SCRAP'";
