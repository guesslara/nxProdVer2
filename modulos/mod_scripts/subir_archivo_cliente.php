...
//		set_time_limit(0);
		...
		foreach($m_renglones as $renglonX){
			...
			$sql="INSERT INTO archivo_Cliente (imei,serial,modelo,lote,tipo) VALUES ('".$m_celdas[0]."','".$m_celdas[1]."','".$m_celdas[2]."','".$_POST["lote"]."','".$_POST["tipo"]."'); ";
...
function subir_datos(){
	...
	var datos_x="ac=subir_datos&lote="+lote+"&datos="+datos_txt+"&tipo="+tipo;
	//alert(datos_x);
...
<body>
<div id="div_main">
	<div id="div_encabezado" style="background:#000; color:#FFF; height:20px; padding:7px; font-size:12px;">Carga Din&aacute;mica de la Base de Datos del Cliente!</div>
	...
	<div id="div_captura"><br />
		Folio : <input type="text" id="txt_id_lote0" /> <br /><br />
		Tipo : <select name="cmbTipo" id="cmbTipo"><option value="" selected="selected">Selecciona...</option><option value="Nacional">Nacional</option><option value="Frontera">Frontera</option></select><br><br>
