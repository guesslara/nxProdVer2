...
//		set_time_limit(0);
		...
		foreach($m_renglones as $renglonX){
			...
			$sql="INSERT INTO entregas (imei,serial,sim,modelo,folio,caja,entrega) VALUES ('".$m_celdas[0]."','".$m_celdas[1]."','".$m_celdas[2]."','".$m_celdas[3]."','".$m_celdas[4]."','".$m_celdas[5]."','".$m_celdas[6]."'); ";
...
<title>Carga Din&aacute;mica de entregas !</title>
...
function ajax(capa,datos,ocultar_capa){
	...
	$.ajax({
		...
		timeout:9000000000000000000000000000000000,
...
function subir_datos(){
	...
	var datos_x="ac=subir_datos&datos="+datos_txt;
	//alert(datos_x);
...
<body>
<div id="div_main">
	<div id="div_encabezado" style="background:#000; color:#FFF; height:20px; padding:7px; font-size:12px;">Carga Din&aacute;mica de entregas!</div>
